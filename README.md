...
React: I created many mini projects and I have even created a real full stack MERN application which can be seen on my repo called "client_database_management". I used hooks, context, Node.js and Express.js to make that which was great! Other React applications on my repo include "githubfinder" and "StructureReport". StructureReport was my time creating a React application, and my first time creating a real application to be used in real life, so it's rough but the roughness taught me many invaluable things. 
